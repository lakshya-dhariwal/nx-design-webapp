    ...
    (
        ...
        return (
            <SliderPrimitive.Root
                ...
                {...props}
            >
                <span className="absolute -left-1 top-2 text-sm text-white">
                    {min}
                </span>
                ...
                {(normalizedValue ?? normalizedDefault).map((val, i) => (
                    <SliderPrimitive.Thumb
                        key={i}
                        className={cn(
                            "focus-visible:ring-primary block h-4 w-4 rounded-full border-[3px] transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50"
                        )}
                        style={{
                ...
                <span className="absolute -right-1 top-2 text-sm text-white">
                    {max}
                </span>
            </SliderPrimitive.Root>
        );
